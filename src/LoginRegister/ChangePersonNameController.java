...
public class ChangePersonNameController {
	...
	@FXML
	private TextField newSurnnameInput;
	@FXML
	private Text text;	
	...
	public void changeName() {
		...
		String newSurname=newNameInput.getText();
		ToDoList todo;
		todo=SetToDo.getToDo();
		
		try {
			todo.changePersonNameAndSurname(newName, newSurname);
